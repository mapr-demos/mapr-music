...
public class Album {
    ...
    private List reviews; // TODO change it to use actual class

    @JsonProperty("artist_list")
    private List artistList; // TODO change it to use actual class

    @JsonProperty("catalog_numbers")
    private List catalogNumbers; // TODO change it to use actual class

    @JsonProperty("track_list")
    private List trackList; // TODO change it to use actual class
    ...
    private String releasedDate; // should we change it to Timestamp, Date or smth else?
